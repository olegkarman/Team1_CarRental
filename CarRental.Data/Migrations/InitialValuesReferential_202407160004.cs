...
{
    [Migration(202407160004)]

    public class InitialValuesReferential_202407160004 : Migration
    {
                ...
                @"
                    ...
                    (
                        SELECT ROUTINE_NAME
                            ...
                            WHERE ROUTINE_NAME = 'GetAllCarsOfCustomer';
                    )
                        BEGIN
                            ...
                            PRINT 'MIGRATION APPLIED SUCCESSFULLY: STORED PROCEDURE GetAllCarsOfCustomer CREATED';
                        END
                    ELSE
                        PRINT 'MIGRATION FAILED: STORED PROCEDURE WITH NAME GetAllCarsOfCustomer ALREADY EXISTS';
                "
            );
        }
            ...
            (
                @"
					...
					(
						...
						BEGIN
							DROP PRUCEDURE GetAllCarsOfCustomer;

							PRINT 'MIGRATION APPLIED SUCCESSFULLY: STORED PROCEDURE GetAllCarsOfCustomer DROPPED';
						END
					ELSE
						BEGIN
							PRINT 'MIGRATION FAILED: STORED PROCEDURE WITH NAME GetAllCarsOfCustomer IS NOT EXIST';
						END
                "
            );
        }
