...
public class InspectorCars
{
    ...
    public InspectorCars()
    {
        ...
        Mileage = rand.Next(0, 300000);       
        ReleaseDate = rand.Next(2000, 2023);  
        ExteriorCondition = rand.Next(1, 11);
        CurrentCarsInspected = 0;
    }
    ...
    public string GetCarInfo(CarRecord car) 
    {
        return $"Car Id:{car.Id}, Year{car.Year}, Mark:{car.Mark}";
    }

    internal async Task InspectCarsAsync(Car car)
    {
     ...
     public void InspectCar(Car car, Inspector inspector, InspectionsManager inspectionManager) 
     {
     ...
     public void RemoveCarIfUnfit(Car car) 
     {
